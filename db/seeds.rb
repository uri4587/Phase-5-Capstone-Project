...
exercise3_for_workout1 = Exercise.create(exercise_name: "Seated Row", instructions: "3 sets, 8-12 reps, 3 RIR", workout_id: workout_for_trainee1.id, youtube_url: "https://www.youtube.com/watch?v=GZbfZ033f74")
exercise4_for_workout1 = Exercise.create(exercise_name: "Flat Bench Press Machine", instructions: "3 sets, 10-20 reps, 3 RIR", workout_id: workout_for_trainee1.id, youtube_url: "https://www.youtube.com/watch?v=aV1U_mK3XOs")
exercise5_for_workout1 = Exercise.create(exercise_name: "Cable Crunches", instructions: "3 sets, 10-20 reps, 3 RIR", workout_id: workout_for_trainee1.id, youtube_url: "https://www.youtube.com/watch?v=AV5PmZJIrrw&t=129s")
