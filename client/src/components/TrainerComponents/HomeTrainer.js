  ...
  const navigate = useNavigate()
      ...
      const actions = [
        ...
        },
        {
            ...
            description: "Add, Edit, Delete, and View Workouts set for your clients",
            url: '/workouts-trainer'
        },
        {
            icon: UsersIcon,
                  ...
                  <div className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:flex sm:space-x-5">
                      ...
                      <div className="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                        ...
                        <p className="text-sm font-medium text-gray-600">{currentUserTrainer.date_of_birth}</p>
                      </div>
                    </div>
